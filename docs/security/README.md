...
| 2 | [Authorization·Project Scope·감사](authorization-and-audit.md) | principal, capability, scope, break-glass, audit의 단일 계약 |
| 3 | [Worker enrollment 계약](../contracts/worker-enrollment.md) | join·register·heartbeat의 현재 제한과 완료 게이트 |
| 4 | [보안 발견 기록](reports/README.md) | 해결·미해결 항목의 historical 근거 |
