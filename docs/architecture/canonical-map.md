...
- [시스템 개요](overview.md): 탐색 지도
- [구현 참조](implementation-reference.md): 코드 구조·제약·검증 근거
- [엔티티 매핑](system-entities-mapping.md): 관계 요약
- [Reviews](../reviews/README.md): 대안, 검토, feasibility, 역사적 판단
