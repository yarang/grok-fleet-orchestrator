...
```
┌───────────────────────────────────────────────────────────────────────┐
│ [시나리오 1: SSH 원클릭 프로비저닝 (자동화)]                            │
│  Orchestrator ───(SSH/SFTP를 통해 임시 생성 후 주입)───► Worker       │
└───────────────────────────────────────────────────────────────────────┘
                                   OR
┌───────────────────────────────────────────────────────────────────────┐
│ [시나리오 2: CLI/대시보드 수동 복사 (수동 / 소규모)]                    │
│  Admin Web/CLI ───(관리자가 수동 복사/붙여넣기)───► Worker CLI         │
└───────────────────────────────────────────────────────────────────────┘
                                   OR
┌───────────────────────────────────────────────────────────────────────┐
│ [시나리오 3: Cloud-init / Metadata 주입 (클라우드 네이티브)]            │
│  Terraform ───(Secrets Manager / User Data 주입)───► Auto-scaling VM  │
└───────────────────────────────────────────────────────────────────────┘
```
