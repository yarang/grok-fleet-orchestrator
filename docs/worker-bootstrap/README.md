...
| [`token-delivery.md`](./token-delivery.md) | 전달 방식 — SSH 자동주입 / CLI 수동 / cloud-init 비교, SSH 자동주입 권장 |
| [`ssh-provisioning.md`](./ssh-provisioning.md) | SSH 자동 프로비저닝 구현 명세 (시퀀스 + 셸 + Rust 의사코드) |
| [`serve-and-bootstrap-design.md`](./serve-and-bootstrap-design.md) | `fleet serve` 모듈 설계 + 부트스트랩/운영 수명주기 |
| [`DEPRECATED-bootstrap-and-worker-features.md`](./DEPRECATED-bootstrap-and-worker-features.md) | ⚫ 폐기 — 위 문서들 및 [`../architecture/overview.md`](../architecture/overview.md)의 Worker Daemon 절과 중복 |
