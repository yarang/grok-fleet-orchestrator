...
| [`litellm_integration_plan.md`](./litellm_integration_plan.md) | liteLLM 게이트웨이 실제 배포 스펙 (venv+systemd, arm2 프로덕션 운용 중) — DB-less, groq-compat 훅, 워커 canary 전환 현황. 원래의 Docker Compose 설계는 §7에 폐기 사유와 함께 보관 | 🟢 정본 — 인프라 **스펙** | 2026-08-11 |
...
| [`README.md`](./README.md) | 위키의 목적, 정본/사본 규칙, 자율 엔진(AutonomicEngine) 연동 설계 명시 (스키마) | ⚪ 스키마 문서 | 2026-08-12 |
...
| [`docs/architecture/overview.md`](../architecture/overview.md) | `README.md` 및 자율 동작 제어 엔진의 연동 설계 인용 | ## Autonomic Self-Healing Engine (Autonomy) |
