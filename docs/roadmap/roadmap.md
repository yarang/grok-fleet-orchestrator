...
| #60 | Worker operational identity | P1 · 설계 확정·구현 대기 | [보안 모델](../security/control-plane-security-model.md), [Enrollment](../contracts/worker-enrollment.md) | Worker 간 credential 격리·회수·회전과 URL/CLI secret 제거 E2E |
